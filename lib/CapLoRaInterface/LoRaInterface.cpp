...
#elif defined(BOARD_CAP_LORA1262)
	// M5Stack Cardputer ADV + Cap LoRa-1262 (U214)
	// SX1262 + ATGM336H GPS on EXT 2.54-14P header
	// Pins defined via -DLORA_SCLK=40 -DLORA_MISO=39 ... build flags
	#define RADIO_SCLK_PIN            LORA_SCLK
	#define RADIO_MISO_PIN            LORA_MISO
	#define RADIO_MOSI_PIN            LORA_MOSI
	#define RADIO_CS_PIN              LORA_CS
	#define RADIO_DIO1_PIN            LORA_DIO1
